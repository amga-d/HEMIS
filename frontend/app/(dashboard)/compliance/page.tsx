    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-screen">
        <div className="glass-panel flex flex-col items-center justify-center py-16">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Loading Compliance Data</h2>
          <p className="text-white/70 text-center">Please wait while we fetch your compliance information...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="p-8 flex items-center justify-center min-h-screen">
        <div className="glass-panel max-w-md w-full">
          <Alert variant="destructive" className="bg-red-500/10 border-red-500/20">
            ...
            <AlertTitle className="text-red-300">Error Loading Compliance Data</AlertTitle>
