...
const cards = [
  {
    title: "Dashboard",
    subtitle: "Monitor key performance indicators (KPIs) like total patients, revenue, and patient inflow in real-time. Get a comprehensive overview of the current status on a single page.",
    ...
    <section id="more-info" className="py-20 px-6 bg-gradient-to-br from-yellow-50 via-purple-50 to-blue-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-7xl mx-auto">
        {cards.map((card, index) => (
          <div 
            key={index} 
            className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 shadow-lg text-left transition hover:scale-105 hover:shadow-xl"
          >
